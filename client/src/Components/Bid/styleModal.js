...
function StyleModal({ styleList, modalVisible, setModalVisible, index }) {
  // state
        ...
        <View style={styles.contentBox}>
          ...
          <View style={styles.tagArea}>
            <View style={styles.tag}>
              <Text style={{ color: '#8D8D8D' }}># {styleList[index].style_type}</Text>
            </View>
            <View style={styles.tag}>
              <Text style={{ color: '#8D8D8D' }}># {styleList[index].length_type}</Text>
            </View>
          </View>
          <View style={styles.subtitleArea}>
            <Text numberOfLines={2} style={styles.subtitleText}>
              {styleList[index].description}
            </Text>
          </View>
