...
function NoHistoryListScreen({ navigation }) {
  return (
    <View style={styles.container}>
      <Ionicons name="document-outline" size={50} />
      <View style={styles.titleBox}>
        <Text style={styles.titleText}>아직 성사된</Text>
        <Text style={styles.titleText}>매칭 내역이 존재하지 않습니다!</Text>
      </View>
...
export default NoHistoryListScreen;
