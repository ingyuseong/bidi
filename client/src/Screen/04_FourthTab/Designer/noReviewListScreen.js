...
function NoReviewListScreen({ navigation }) {
  return (
    <View style={styles.container}>
      <Ionicons name="document-outline" size={50} />
      <View style={styles.titleBox}>
        <Text style={styles.titleText}>현재 시간 기준으로</Text>
        <Text style={styles.titleText}>받은 리뷰 내역이 존재하지 않습니다!</Text>
      </View>
...
export default NoReviewListScreen;
